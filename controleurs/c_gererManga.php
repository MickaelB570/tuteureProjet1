                    ...
                    switch($panier)
                    {
                        case "ajouter" :
                        {
                            if(isset($_GET['vol']))
                            {
                                ...
                                $msg_ajout_panier = $volume_msg." ".$vol."  ".$manga_msg." ".$leManga->getNom_manga()." ".$ajout_msg;
                            } else
                            {
        ...
        switch ($option) {
            ...
            case 'validerSaisie': {
                    ...
                    if ($hasErrors) {
                        ...
                        $lien = '<a href="?uc=gererOuvrages&action=ajouterOuvrage">retour à saisie</a>';
                        include "views/_v_afficherErreurs.php";
                    }
                }
        }
    ...
    case "modifierManga": {
        if($estAdministrateur == false) {
            ...
            if (!$hasErrors) {
                ...
                $lien = '<a href="?uc=gererManga&action=modifierManga">Retour à la saisie</a>';
                include 'views/_v_afficherErreurs.php';
            }
