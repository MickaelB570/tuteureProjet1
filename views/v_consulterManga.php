           ...
           <table>
                ...
                <tr>
                    <?php
                        ...
                        {
                            ?>
                                <td><p class="pays"><?= $pays ?> : <?= $pays_origine ?></p></td>
                            <?php
                        } else
                        {
                            ?>
            ...
            <table>
                ...
                <?php
                        ...
                        {
                            ?>
                            <td><p class="etat"><?= $etat ?> : <?= $en_cours ?></p></td>
                            <?php
                        } else
                        {
                            ?>
...
'toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=yes, copyhistory=no, width=600, height=350'); return false;">Ajouter au panier</a> -->
            ...
            {
                ?>
                <button class="btn margin-auto bg-primary text-light" onclick="" ><a class="text-light" href=""><?= $stock_vide ?></a>
                </button>
                <?php
            }
            ?>
